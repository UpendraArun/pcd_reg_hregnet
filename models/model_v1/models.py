...
class Model_V1(nn.Module):
    ...
    def forward(self, src_points, dst_points):
        ...
        # Coarse registration
        src_xyz_corres_3, src_dst_weights_3, src_dst_weights_3_prime, src_dst_feats_3, src_dst_feats_3_prime = self.coarse_corres(src_feats['xyz_3'], src_feats['desc_3'], dst_feats['xyz_3'], \
        ...
        ret_dict['src_dst_feats_3'] = src_dst_feats_3
        ret_dict['src_dst_feats_3_prime'] = src_dst_feats_3_prime
        ret_dict['src_dst_weights_3_prime'] = src_dst_weights_3_prime
