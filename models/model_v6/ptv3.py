...
class Block(PointModule):
    ...
    def forward(self, point: Point):
        ...
        x = point.feat
        # layer_name = f"{self.__class__.__name__} (CPE, order_index={0})"
        # if torch.isnan(x).any():
        #     print(f"NaN detected in {layer_name} output!")
        # if torch.isinf(x).any():
        #     print(f"Inf detected in {layer_name} output!")
...
class Embedding(PointModule):
    ...
    def forward(self, point: Point):
        ...
        # layer_name = f"{self.__class__.__name__} (stem)"
        # if torch.isnan(point.feat).any():
        #     print(f"NaN detected in {layer_name} output!")
        # if torch.isinf(point.feat).any():
        #     print(f"Inf detected in {layer_name} output!")
        return point
