...
class CoarseReg(nn.Module):
    ...
    def forward(self, src_xyz, src_desc, dst_xyz, dst_desc, src_weights, dst_weights):
        ...
        coord_dist = src_rela_dist.squeeze(-1).contiguous()
        ...
        return corres_xyz, weights, coord_dist, feats_dist#, weights_prime, attentive_features, attentive_features_prime
...
class WeightedSVDHead(nn.Module):
    ...
    def forward(self, src, src_corres, weights):
        ...
        #         print(f"NaN detected in src!")
        # if torch.isnan(src_corres).any():
        #         print(f"NaN detected in src_corres!")
        ...
        if torch.isnan(cov_mat).any():
            print("NaN in covariance matrix!")
        ...
        try:
            ...
            print("SVD Failure", e)
            print("Covariance matrix values:", cov_mat)
