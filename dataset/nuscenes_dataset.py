...
class TruckScenesDataset(Dataset):
    def __init__(self,  trucksc: TruckScenes, config:Config):
        ...
        self.scene_tokens = self.get_scene_tokens(split=self.config.dataset_config.split)
...
class TruckScenesPerturbation():
    def __init__(self, dataset: TruckScenesDataset, config:Config):
        ...
        if self.config.dataset_config.perturbations_file is not None and self.config.dataset_config.split == 'mini_val':
